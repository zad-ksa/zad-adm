  ...
  return (
    <main className="flex-1 min-w-0 py-5">
      ...
      <div className="mb-5">
        <StatStrip
          items={[
            { label: "الجمعيات المتعاقد معها", value: charities.length },
            { label: "المنح", value: displayGrants.toLocaleString(), unit: "ريال" },
            { label: "عدد البرامج", value: displayPrograms.toLocaleString() },
            { label: "عدد المستفيدين", value: displayBeneficiaries.toLocaleString() },
          ]}
        />
      </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between text-caption">
                        ...
                        <span className="font-semibold text-emerald-800 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-900/30 backdrop-blur-md px-2 py-0.5 rounded-md text-caption shrink-0 border border-emerald-500/20 dark:border-emerald-500/30 shadow-sm">
                      ...
                      <div className="flex items-center justify-between text-caption">
                        ...
                        <span className="font-semibold text-violet-800 dark:text-violet-300 bg-violet-500/10 dark:bg-violet-900/30 backdrop-blur-md px-2 py-0.5 rounded-md text-caption shrink-0 border border-violet-500/20 dark:border-violet-500/30 shadow-sm">
                      ...
                      <div className="flex items-center justify-between text-caption">
                        ...
                        <span className="font-semibold text-indigo-800 dark:text-indigo-300 bg-indigo-500/10 dark:bg-indigo-900/30 backdrop-blur-md px-2 py-0.5 rounded-md text-caption shrink-0 border border-indigo-500/20 dark:border-indigo-500/30 shadow-sm">
