      ...
      <div className="max-w-5xl mx-auto mb-12">
        <PageHeader
          crumbs={charityCrumbs(
            charityName,
            { label: "الحوكمة", href: `/main/governance/${encodeURIComponent(charityName)}?change_size=true` },
            { label: "المعايير والممارسات المعتمدة" }
          )}
          icon={<Scale className="w-6 h-6" />}
          title="المعايير والممارسات المعتمدة"
          description={`معايير وشواهد ${sizeLabels[sizeParam]} — المعايير الأساسية، والممارسات الدقيقة، والشواهد المطلوبة لإثبات الامتثال، مصممة للإدارة العليا للجمعية.`}
        />
      </div>
