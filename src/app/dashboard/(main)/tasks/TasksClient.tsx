  ...
  return (
    <main className="flex-1 min-w-0 py-8 relative" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100 dark:text-slate-100 flex items-center gap-3">
            <CheckSquare className="w-8 h-8 text-primary" />
            المهام والمنجزات
          </h1>
          <p className="text-slate-600 dark:text-slate-300 dark:text-slate-300 mt-1 font-medium">
        ...
        {isDirectorOrAdmin && (
          <div className="flex items-center gap-3 bg-white dark:bg-slate-800 dark:bg-slate-800 px-4 py-2 border border-slate-100 dark:border-slate-800/80 dark:border-slate-800/80 rounded-2xl shadow-sm shrink-0">
            ...
            <select
              ...
              className="text-sm font-bold text-slate-700 dark:text-slate-200 dark:text-slate-200 bg-transparent border-none outline-none cursor-pointer pr-1 pl-6"
            >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="space-y-1.5 flex-1">
                        {editingTaskId === task.id ? (
                          <div className="flex items-center gap-1.5 w-full">
                            <input
                              ...
                              className="flex-1 bg-white dark:bg-slate-800 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 dark:border-slate-700 rounded-lg px-2.5 py-1 text-xs outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary/30 text-slate-800 dark:text-slate-100 dark:text-slate-100 font-bold"
                              onKeyDown={(e) => {
                          ...
                          <h4 className="font-bold text-slate-800 dark:text-slate-100 dark:text-slate-100 text-sm leading-relaxed">
                            {task.title}
                          </h4>
                        )}
                        ...
                        <div className="flex flex-wrap items-center gap-1.5">
                          {task.isInternal ? (
                            <span className="inline-flex items-center gap-1 text-[10px] font-bold text-slate-500 dark:text-slate-400 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 dark:bg-slate-800 px-2 py-0.5 rounded">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-800/80 dark:border-slate-800/80 shadow-2xl w-full max-w-md overflow-hidden relative z-10 transform transition-all duration-300 scale-100 p-6 space-y-6" dir="rtl">
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 dark:text-slate-400 mt-2 leading-relaxed">
                يجب إرفاق شاهد (صورة) كإثبات على إنجاز المهمة. سيتم حفظ هذا الشاهد للتوثيق والتدقيق.
              </p>
            </div>

            <form onSubmit={handleProofSubmit} className="space-y-4">
              <div className="border-2 border-dashed border-slate-200 dark:border-slate-700 dark:border-slate-700 rounded-2xl p-6 text-center bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 relative hover:border-primary/50 transition-colors">
                <input
                  type="file"
                  accept="image/*"
                  required
                ...
                {proofFile ? (
                  <p className="text-sm font-bold text-slate-800 dark:text-slate-100 dark:text-slate-100">{proofFile.name}</p>
                ) : (
                  <div>
                    <p className="text-sm font-bold text-slate-600 dark:text-slate-300 dark:text-slate-300">انقر أو اسحب الصورة هنا</p>
          ...
          <div className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-800/80 dark:border-slate-800/80 shadow-2xl w-full max-w-lg overflow-hidden relative z-10 transform transition-all duration-300 scale-100 p-6 md:p-8 space-y-6" dir="rtl">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800/80 dark:border-slate-800/80 pb-4">
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 dark:text-slate-400 font-medium mt-1.5">
            ...
            <form onSubmit={(e) => {
              ...
              <div>
                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 dark:text-slate-400 mb-2">عنوان المهمة</label>
                <textarea
                  value={taskTitle}
                  ...
                  rows={3}
                  required
                  className="w-full bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 dark:border-slate-700 rounded-xl px-4 py-3 text-sm outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary/30 text-slate-800 dark:text-slate-100 dark:text-slate-100 transition-all font-medium resize-none"
                />
              </div>
              ...
              {isDirectorOrAdmin && (
                <div>
                  <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 dark:text-slate-400 mb-2 flex items-center gap-1">
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 dark:border-slate-700 rounded-xl px-4 py-3 text-sm outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary/30 text-slate-800 dark:text-slate-100 dark:text-slate-100 transition-all font-bold cursor-pointer"
                  >
                    {employees.map((emp) => (
                      <option key={emp.id} value={emp.id}>
                        {emp.name}
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="bg-white dark:bg-slate-800 dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-800/80 dark:border-slate-800/80 shadow-2xl w-full max-w-md overflow-hidden relative z-10 transform transition-all duration-300 scale-100 p-6 md:p-8 space-y-6" dir="rtl">
            ...
            <form onSubmit={handleCreateAchievement} className="space-y-5">
              <div>
                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 dark:text-slate-400 mb-2">ماذا أنجزت؟</label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 dark:border-slate-700 rounded-xl px-4 py-3 text-sm outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500/30 text-slate-800 dark:text-slate-100 dark:text-slate-100 transition-all font-medium"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 dark:border-slate-700 rounded-xl px-4 py-3 text-sm outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500/30 text-slate-800 dark:text-slate-100 dark:text-slate-100 transition-all font-bold cursor-pointer"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 dark:border-slate-700 rounded-xl px-4 py-3 text-sm outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500/30 text-slate-800 dark:text-slate-100 dark:text-slate-100 transition-all font-medium cursor-pointer"
                />
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-slate-200 dark:border-slate-700 dark:border-slate-700 rounded-xl p-4 text-center bg-slate-50 dark:bg-slate-900/50 dark:bg-slate-900/50 relative hover:border-emerald-500/50 transition-colors">
                  <input
                    type="file"
                    accept="image/*"
                    required
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    {achievementProofFile ? (
                      <span className="text-xs font-bold text-slate-800 dark:text-slate-100 dark:text-slate-100 truncate max-w-[200px]">
                        {achievementProofFile.name}
                      </span>
                    ) : (
                      <span className="text-xs font-bold text-slate-600 dark:text-slate-300 dark:text-slate-300">ارفع صورة كشاهد للإنجاز</span>
                    )}
                  </div>
                </div>
              </div>
