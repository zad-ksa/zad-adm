...
export default function Header({ 
  ...
  const logoContent = (
    <div className={`flex items-center ${disableLink ? "" : "group"}`}>
      <div className={`relative w-20 h-20 sm:w-24 sm:h-24 transition-transform duration-300 ${disableLink ? "" : "group-hover:scale-105"}`}>
        <Image
