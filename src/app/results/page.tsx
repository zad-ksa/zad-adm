          ...
          <p className="text-slate-600 text-lg leading-relaxed mb-10 max-w-md mx-auto">
            {isHexagonal ? (
              <>
                ...
                <br />
                تم استلام بيانات جمعيتكم بنجاح، وسيقوم فريق المختصين في <strong>زاد التنموية</strong> بمراجعة وتحليل الإجابات بدقة، وسيتم التواصل معكم قريباً لتحديد اجتماع لمناقشة النتائج.
              </>
            ) : (
              <>
                شكراً لوقتكم في تعبئة استبيان جاهزية التخطيط الاستراتيجي.
                <br />
                تم استلام بيانات جمعيتكم بنجاح، وسيقوم فريق المختصين في <strong>زاد التنموية</strong> بمراجعة وتقييم الإجابات بدقة، وسيتم التواصل معكم قريباً لتحديد اجتماع لمناقشة النتائج.
              </>
            )}
          </p>
        </div>
