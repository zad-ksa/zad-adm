    ...
    <main className="flex-1 min-w-0 py-8 relative" dir="rtl">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="space-y-8">
          ...
          {/* Filters Card */}
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-100 dark:border-slate-800/80 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800/80 rounded-xl px-4 py-3 text-sm outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary/30 focus:bg-white dark:bg-slate-800 text-slate-805 transition-all font-bold cursor-pointer"
                >
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800/80 rounded-xl px-4 py-2.5 text-sm outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary/30 focus:bg-white dark:bg-slate-800 text-slate-805 transition-all font-bold cursor-pointer"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filteredNews.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-100 dark:border-slate-800/80 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 flex flex-col justify-between group"
                  >
                    <div>
              ...
              {filteredNews.length === 0 && (
                <div className="col-span-full bg-white dark:bg-slate-800 rounded-2xl p-16 text-center text-slate-400 border border-slate-100 dark:border-slate-800/80 shadow-sm">
        ...
        {isSecretariatOrAdmin && showNewsForm && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            />
            <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-800/80 shadow-2xl w-full max-w-lg overflow-hidden relative z-10 transform transition-all duration-300 scale-100 p-6 md:p-8 max-h-[90vh] overflow-y-auto" dir="rtl">
