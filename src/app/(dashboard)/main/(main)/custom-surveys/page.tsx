  ...
  return (
    <div className="p-8 max-w-7xl mx-auto dark:bg-slate-900">
      ...
      {surveys.length === 0 ? (
        ...
        <div className="bg-white border border-slate-200 rounded-xl shadow-[0_1px_2px_rgb(15_23_42/0.04)] divide-y divide-slate-100 dark:bg-slate-900 dark:border-slate-800 dark:divide-slate-700">
          {surveys.map((survey) => (
