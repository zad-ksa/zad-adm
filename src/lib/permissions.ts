...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    permissions: [
      ...
      // Employee.permissions وفي جلسات مفتوحة الآن — تغييره يسلب الصلاحية
      // من حاملها حتى يُهاجَر الصفّان وتُحدَّث الجلسة. العنوان هو ما يراه
      // المستخدم، وهو الاسم الجديد.
      ...
      // تعميد البريد الصادر إلى الجمعيات: من يملكها يعيّن معمِّد كل خدمة.
