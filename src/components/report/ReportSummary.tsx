...
export default function ReportSummary({ axes, quarter, year = new Date().getFullYear() }: ReportSummaryProps) {
  ...
  return (
    <>
      ...
      <div className="hidden print:flex flex-col items-center justify-center w-full min-h-[90vh] break-after-page page-break-after-always bg-white relative overflow-hidden">
