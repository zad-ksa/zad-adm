...
نأمل من سعادتكم التكرم باختيار الموعد المناسب لكم لعقد "${scheduleTitle}" من خلال الرابط التالي، حيث يمكنكم استعراض الأوقات المتاحة وحجز ما يناسبكم منها مباشرة:
