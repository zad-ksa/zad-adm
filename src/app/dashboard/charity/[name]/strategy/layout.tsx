...
export default async function StrategyLayout({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 bg-white rounded-b-3xl rounded-tl-3xl p-6 md:p-8 shadow-sm border border-slate-200 print:shadow-none print:border-none print:p-0 print:m-0">
        {children}
      </div>
    </div>
  );
