        ...
        {step === "register" && (
          <div className="bg-white border border-slate-200 rounded-2xl p-8 sm:p-10 w-full animate-in fade-in duration-300 max-w-xl mx-auto shadow-sm" dir="rtl">
            ...
            <form
              onSubmit={(e) => {
                e.preventDefault();
                // كان المتصفّح يمنع الانتقال بـrequired على القائمة الأصلية.
                if (!registrationData.authorizedTitle) return;
                setStep("survey");
              }}
              className="space-y-6"
            >
              ...
              <div>
                ...
                <div className="relative">
                  <Select
                    ...
                    onSelect={(v) => setRegistrationData(prev => ({ ...prev, authorizedTitle: v }))}
