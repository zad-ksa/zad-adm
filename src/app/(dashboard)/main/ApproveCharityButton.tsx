...
export default function ApproveCharityButton({
  ...
  return (
    <button
      ...
      disabled={isPending}
      className={`px-4 py-2 rounded-lg text-caption font-semibold transition-all flex items-center justify-center gap-1.5 shadow-sm active:scale-[0.98] border cursor-pointer select-none
        ${
          isPending
