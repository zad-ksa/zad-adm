...
export default async function GovernanceStandardsPage({ 
  ...
  return (
    <div className="min-h-full bg-[#FAFAFA] dark:bg-[#0A0A0A] p-4 md:p-8 selection:bg-primary/20 selection:text-primary" dir="rtl">
      ...
      <div className="mb-12 max-w-5xl mx-auto space-y-6">
        ...
        <p className="text-slate-500 dark:text-slate-400 max-w-2xl font-medium leading-relaxed text-sm md:text-base">
          توضح هذه الصفحة المعايير الأساسية، والممارسات الدقيقة، والشواهد المطلوبة لإثبات الامتثال لدى {sizeLabels[sizeParam]}.
        </p>
      </div>
