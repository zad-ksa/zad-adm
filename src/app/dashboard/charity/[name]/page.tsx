  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-64 h-64 bg-primary/5 rounded-full -ml-20 -mt-20 blur-3xl pointer-events-none" />
        
        <div className="relative z-10">
          <h1 className="text-3xl font-bold text-slate-800 mb-2">الملف التعريفي للجمعية</h1>
          <p className="text-slate-500 mb-8">نظرة عامة على البيانات الأساسية لـ {decodedName}</p>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
              <div className="text-sm font-semibold text-slate-500 mb-2">اسم الجمعية</div>
              <div className="text-xl font-bold text-slate-800">{decodedName}</div>
            </div>

            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
              <div className="text-sm font-semibold text-slate-500 mb-2">تاريخ التأسيس</div>
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
              <div className="text-sm font-semibold text-slate-500 mb-2">رقم التصريح</div>
              <div className="text-xl font-bold text-slate-800">
      ...
      <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200">
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-bold text-slate-800 mb-2">المزيد من البيانات قريباً</h3>
