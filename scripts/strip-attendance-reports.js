// نزع «الاعتمادات» (view_zad_attendance_reports) من كل موظف ومسمى ومجموعة.
//
// صار رفع الطلب ومتابعته لكل موظف بلا صلاحية. والاعتماد ومتابعة الجميع
// يبقيان بـview_zad_attendance_reports وreview_all_requests.
//
...
const ID = "view_zad_attendance_reports";
...
(async () => {
  ...
  const file = path.join(__dirname, "backup-attendance-reports-" + stamp + ".json");
