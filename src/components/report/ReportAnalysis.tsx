...
export default function ReportAnalysis() {
  ...
  return (
    <>
      ...
      {/* PRINT VIEW (4 Slides Landscape Layout) */}
      
      {/* 1. General Analysis Divider/Cover Page */}
      <div className="hidden print:flex w-full h-[190mm] max-h-[190mm] break-after-page page-break-after-always bg-white relative overflow-hidden font-sans box-border" dir="rtl">
      ...
      <div className="hidden print:flex flex-col w-full h-[190mm] max-h-[190mm] break-after-page page-break-after-always bg-white relative overflow-hidden font-sans box-border py-4 px-12 justify-between" dir="rtl">
        {/* Header Bar */}
