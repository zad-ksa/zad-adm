...
import StrategicStagesManager from "@/app/(dashboard)/main/(main)/strategy/[name]/strategy/StrategicStagesManager";
import GovernanceStagesManager from "@/app/(dashboard)/main/(main)/governance/[name]/governance/GovernanceStagesManager";
import FinanceStagesManager from "@/app/(dashboard)/main/(main)/finance/[name]/finance/FinanceStagesManager";
