    ...
    <div className="space-y-6">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="p-1.5 text-slate-500 hover:text-primary hover:bg-slate-150 rounded-lg transition-colors cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
      ...
      {editingEmployee && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-2xl w-full max-w-lg overflow-hidden relative z-10 animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col font-sans" dir="rtl">
            {/* Header */}
            <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between shrink-0">
              <h3 className="text-lg font-bold text-slate-800">تعديل بيانات وصلاحيات الموظف</h3>
              <button 
            ...
            <form onSubmit={handleEditSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      disabled={isPending}
                      className="appearance-none block w-full pr-10 pl-3 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm font-bold text-slate-800" 
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      disabled={isPending}
                      dir="ltr"
                      className="appearance-none block w-full pr-10 pl-3 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm font-bold text-slate-800 text-right" 
                    />
                  </div>
                </div>

                <div>
                  <label className="block text-xs font-bold text-slate-500 mb-2">نوع الحساب</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                    ...
                    <select 
                      ...
                      className="appearance-none block w-full pr-10 pl-3 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm font-bold text-slate-800 bg-white cursor-pointer"
                    >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="placeholder:text-slate-300 appearance-none block w-full pr-10 pl-3 py-2.5 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-sm font-medium text-slate-800 text-right" 
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-slate-100">
                <h4 className="text-sm font-bold text-slate-700 mb-3">الصلاحيات المخصصة</h4>
