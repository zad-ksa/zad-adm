...
export default function FinanceStagesManager({ 
  ...
  const { isExpanded, toggle: toggleExpanded, expand: expandPanel } = useServiceAccordion("finance");
      ...
      {isExpanded && (
        ...
        <div className="p-6 border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/30">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-4">
            <div className="flex-1">
              ...
              <input 
                ...
                className="w-full border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-100 rounded-lg px-3 py-2 text-caption focus:ring-2 focus:ring-amber-500/50 outline-none"
              />
            </div>
            <div className="flex-1">
          ...
          <div className="flex gap-2">
            <button onClick={handleConfigUpdate} className="flex items-center gap-1.5 px-4 py-2 text-white bg-amber-500 hover:bg-amber-600 rounded-lg text-caption font-semibold" disabled={isPending}>
