      ...
      <div className="h-16 border-b border-gray-100 flex items-center justify-between px-4 sm:px-6 shrink-0 bg-white">
        ...
        <div className="flex items-center gap-2">
          <button 
            ...
            className="p-2 text-gray-500 hover:text-primary hover:bg-primary/5 rounded-lg transition-colors flex items-center gap-2"
          >
            <Reply className="w-5 h-5" />
            <span className="text-sm font-medium hidden sm:inline">رد</span>
          </button>
          <button 
          ...
          >
            ...
            <span className="text-sm font-medium hidden sm:inline">إعادة توجيه</span>
          </button>
