  ...
  if (!response) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 font-sans transition-colors" dir="rtl">
        <div className="text-center bg-white dark:bg-slate-800 p-12 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm max-w-md w-full mx-4 flex flex-col items-center transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {Object.entries(METADATA).map(([key, meta]) => {
          ...
          return (
            <div 
              key={key} 
              className={`bg-white dark:bg-slate-800 rounded-xl p-8 border ${meta.borderClass} shadow-sm relative overflow-hidden transition-colors`}
            >
