// نزع «المهام والمنجزات» (manage_tasks) من كل موظف ومسمى ومجموعة.
//
// صار تبويب المهام لكل موظف بلا صلاحية: الصفحة تفتح على مهامه هو، و
// view_all_tasks وحدها ترفع السقف إلى مهام الآخرين.
//
...
(async () => {
  ...
  const file = path.join(__dirname, "backup-manage-tasks-" + stamp + ".json");
