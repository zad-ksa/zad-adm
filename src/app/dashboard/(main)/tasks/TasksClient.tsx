  ...
  return (
    <main className="flex-1 min-w-0 py-8 relative" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
        ...
        {isDirectorOrAdmin && (
          <div className="flex items-center gap-3 bg-white dark:bg-slate-800 px-4 py-2 border border-slate-100 dark:border-slate-800/80 rounded-2xl shadow-sm shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          {/* Active Tasks Column */}
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-800/80 p-6 shadow-sm space-y-5">
            ...
            <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
              {filteredActiveTasks.map((task) => {
                ...
                return (
                  <div 
                    key={task.id} 
                    className="border border-slate-100 dark:border-slate-800/80 hover:border-primary/20 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all duration-300 group relative flex flex-col justify-between gap-3 bg-slate-50 dark:bg-slate-900/50/30"
                  >
                    ...
                    {/* Task Actions */}
                    <div className="flex items-center justify-between border-t border-slate-100 dark:border-slate-800/80/60 pt-3 text-[10px] text-slate-400 font-bold">
              ...
              {filteredActiveTasks.length === 0 && (
                <div className="text-center py-16 text-slate-400 border border-dashed border-slate-100 dark:border-slate-800/80 rounded-2xl">
            ...
            <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
              {combinedAchievements.map((item) => {
                ...
                return (
                  <div 
                    key={item.id} 
                    className={`border border-slate-100 dark:border-slate-800/80 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all duration-300 relative flex flex-col justify-between gap-3 ${
      ...
      {completingTaskId && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          />
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-800/80 shadow-2xl w-full max-w-md overflow-hidden relative z-10 transform transition-all duration-300 scale-100 p-6 space-y-6" dir="rtl">
            <div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-800/80 shadow-2xl w-full max-w-md overflow-hidden relative z-10 transform transition-all duration-300 scale-100 p-6 space-y-6" dir="rtl">
            ...
            <form onSubmit={handleReassignTask} className="space-y-4">
              <select
                ...
                required
                className="w-full bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800/80 rounded-xl px-4 py-3 text-sm outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary/30 focus:bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-100 transition-all font-bold cursor-pointer"
              >
      ...
      {showTaskForm && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          />
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-800/80 shadow-2xl w-full max-w-lg overflow-hidden relative z-10 transform transition-all duration-300 scale-100 p-6 md:p-8 space-y-6" dir="rtl">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800/80 pb-4">
              ...
              <button
                onClick={() => setShowTaskForm(false)}
                className="p-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 text-slate-500 dark:text-slate-400 rounded-full transition-colors cursor-pointer"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
      ...
      {showDirectAchievementForm && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          />
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-100 dark:border-slate-800/80 shadow-2xl w-full max-w-md overflow-hidden relative z-10 transform transition-all duration-300 scale-100 p-6 md:p-8 space-y-6" dir="rtl">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800/80 pb-4">
              <div>
                <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
